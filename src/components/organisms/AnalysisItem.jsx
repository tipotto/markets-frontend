...
import analysisItemStyles from '../../style/analysisItem';
...
// const Item = ({ item, selected, handleSelect, empty }) => {
const Item = ({ item, selected, handleSelect }) => {
  const {
    root,
    emptyBox,
    header,
